...
// Função para exibir os resultados dos formulários
function show_form_results($atts) {
    ...
    // Filtrar e exibir áudios de introdução e áudio do número de destino
    if ($form === 'form1_submission_data') {
        ...
        $destiny_audio = $all_repeaters['_numeros_destino_516'][$destiny_number] ?? 'Nenhum áudio encontrado para o número de destino.';
        ...
        print_r($destiny_audio);
        echo '</pre>';
        return ob_get_clean();
    }

    // Exibir os dados do formulário conforme recebido
    ob_start();
    echo '<pre>';
    print_r($data);
    echo '</pre>';
...
// Shortcode para exibir os dados do JetEngine
